/**
 * Seed 5 bookings for September 8, 2026 (today) from 3:00 PM onward.
 * Creates both BookingService and Assignment documents.
 *
 * Usage:  node scripts/seed-sep08-3pm.js
 */
...
const WORK_DATE = new Date("2026-09-08T00:00:00");
...
async function run() {
  ...
  if (!customer) {
    ...
    customer = await User.create({
      firstName: "Seed",
      lastName: "Customer",
      email: "seed-sep08-customer@example.com",
      phone: "09171234567",
  ...
  for (let i = 0; i < BOOKINGS.length; i++) {
    ...
    const assignment = await Assignment.create({
      ...
      notes: [
        {
          text: "Seed booking created for Sep 8 afternoon/evening testing",
          byName: "System",
          createdAt: new Date(),
        },
      ],
